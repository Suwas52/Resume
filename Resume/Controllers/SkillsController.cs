    ...
    public class SkillsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Skill != null ? 
                          ...
                          Problem("Entity set 'ResumeContext.Skill'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("skill_id,skill_title,skills_name,info_id")] Skill skill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("skill_id,skill_title,skills_name,info_id")] Skill skill)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ResumeContext.Skill'  is null.");
            }
            var skill = await _context.Skill.FindAsync(id);
            if (skill != null)
            {
