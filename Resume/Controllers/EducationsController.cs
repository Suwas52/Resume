...
namespace Resume.Controllers
{
    public class EducationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("education_id,school_name,date,university_name,info_id")] Education education)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("education_id,school_name,date,university_name,info_id")] Education education)
        {
